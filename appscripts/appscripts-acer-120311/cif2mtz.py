...
def main() :
    ...
    parser.add_option("--out", action='store', type='string', dest='out', help='starting pdb containing a model of pdb-ligand complex')
    ...
    shutil.copyfile(options.sf, "%s/%s" % (options.scratchdir,options.sf))
    ...
    uniqueify("base.mtz", options.out)
    import sys ; sys.exit()
