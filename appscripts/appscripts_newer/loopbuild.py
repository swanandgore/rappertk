...
from prepareChain import removeSC, mergeBRlists, addNdummyGly, addCdummyGly, printResAtoms, PrepareChain, prepareRNAchain, incompleteSCcorrection
...
def locateRegionsRandomize(resids, chids, badresids) :
    ...
    #print "order", order
   ## order = [1, 10, 9, 3, 5, 7, 0, 8, 2, 11, 6, 4]
    rloops, rlooptypes = [], []
    for oi in order : rloops.append( loops[oi] ) ; rlooptypes.append( looptypes[oi] )
