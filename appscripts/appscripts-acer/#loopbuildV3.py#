            ...
            if looptypes[k] == "NtoC" :
                if len(chainBreaks) > 0:
                    ...
                    for r in range(len(chainBreaks)):
                        ...
                        if loops[k][0] == chainBreaks[r] :
                            prevstop = loops[k][0]
                            continue
                        if ' CA ' not in res[prevstop+1].keys() :
                            continue
                    ...
                    if (prevstop+1 in res.keys() and ' CA ' not in res[prevstop+1].keys()) or (prevstop+2 not in res.keys() )  or  (' CA ' not in res[prevstop+2].keys()) :
                        print "WLT-noCA",prevstop+1,loops[k][1]
                        ...
                        print "WLT2",prevstop+1,loops[k][1]
