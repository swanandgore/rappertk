...
def main() :
    ...
    parser.add_option("--maptype", action='store', type='string', dest='mapformat', help='options are [cns,2fofc]', default="cns")
    ...
    for cycle in range(startCycle, numRefCycles) :
        ...
        from protmodel import main as  prefRapperMain
