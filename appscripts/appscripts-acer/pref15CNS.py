...
def main() :
    ...
    from pref15 import removeMODEL
    ...
    for cycle in range(startCycle, numRefCycles) :
        ...
        prefRapperMain(cnsout,rtkmodel,options.scratchdir,None,phasedmtz,options.caRes,options.scRes,options.caRad,options.scRad,scvdwr,popsize,options.verbose,options.backtrack,rotlib, 1 , "False", "False" , "True" , 1 , 5.0 ,options.a,options.b,options.c,options.alpha,options.beta,options.gamma,options.sg,options.resolution,"FP","SIGFP",None,None,"True","FreeR_flag",2,"True",xscoreCutoff,None,None,None,None,None,None,"False","False",20.0,30.0,0.25,2.0,"False","False")
