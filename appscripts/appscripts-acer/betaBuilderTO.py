...
import prot2res
from prepareChain import prepareBetaSheet, prepareAlphaHelix, addNCdummyGly, removeSC, mergeBRlists, makeCApropRestraints
...
def main() :
    ...
    for strands, dirs, interStrand, corrInds, sheetBS in sheets : # sheets
        ...
        #
	#01062011:Takashi:Commented out lines containing hydlistB and added another line not-containing hydlistB
	#
        #blist1, bfoll1, numtrials1, rlist1, hydlistB = prepareBetaSheet(res, resids, resnums, resns, chids, inscodes, pts, options.caRad, starts, ends, sheetBS, dirs, corrInds, options.mconly, options.informed)
	blist1, bfoll1, numtrials1, rlist1 = prepareBetaSheet(res, resids, resnums, resns, chids, inscodes, pts, options.caRad, starts, ends, sheetBS, dirs, corrInds, options.mconly, options.informed)
	...
	#
	#01062011:Takashi:Commented out lines containing hydlistH and added another line not-containing hydlistH
	#
        #blist1, bfoll1, numtrials1, rlist1,hydlistH = prepareAlphaHelix(htype, res, resids, resnums, resns, chids, inscodes, pts, options.caRad, helix[0], helix[1], helixBS, options.mconly, options.informed)
        blist1, bfoll1, numtrials1, rlist1 = prepareAlphaHelix(htype, res, resids, resnums, resns, chids, inscodes, pts, options.caRad, helix[0], helix[1], helixBS, options.mconly, options.informed)
    ...
    #
    #01062011:Takashi:Commented out the next four lines
    #
    #esmin, esmax, esmean, rcmult = .000, 5., .0, 5
    ...
    #strategy.ranker = ranker :01062011:Takashi:Commented out
