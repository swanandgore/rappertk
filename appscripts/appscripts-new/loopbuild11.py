...
#        import sys; sys.exit()
        ...
        for kx in range(len(loops)):
            if loops[kx][1] - loops[kx][0] > 600  and (looptypes[kx] == "NtoC" or looptypes[kx]== 'Cter' or looptypes[kx] == 'Nter') and s.caRad != None :
...
################# End - - - - Add missing atoms ###################################################                
        ...
        for li in range(len(loops)) :
            ...
            if s.sconly == 1 :
                ...
                if endindex-startindex <= 200 :   #or random.random() > 1.5 :
...
#                print "makind fummy", resids[k],an
        ...
        if s.allopt   == 1 :
            ...
            for ori in range(len(rlist)) :
                extraRestrOpt.append(ori)
                #extraRestrOpt.append(ori+rsize)
#        for ori in optional : extraRestrOpt.append(rsize + ori)
