   ...
   ################   COPY MAP AND MTZ FILES  #########################################
    ...
    if  mapfn != None:
        ...
        if poorOnly == 1 :
            ...
            badmcsc,id1 = xscorer.score(pdbfile, mapfn, fcmap, f2label, phiclabel, mapcoeff, "mcsc",verbose)
            badmc,id2 = xscorer.score(pdbfile, mapfn, fcmap, f2label, phiclabel, mapcoeff, "mc",verbose )
            badpept,id3 = xscorer.score(pdbfile, mapfn, fcmap, f2label, phiclabel, mapcoeff, "pept",verbose )
            badsides,id4 = xscorer.score(pdbfile, mapfn, fcmap, f2label, phiclabel, mapcoeff, "sc",verbose)
    ...
    for  i in range(nmodels):
        ...
        if mtzfn != None :
            ...
            sfall(outpdbsc, mtzfn, "phased."+str(i)+".mtz",resolution,usefreer,f1label,sigf1label,freeRlabel ) 
